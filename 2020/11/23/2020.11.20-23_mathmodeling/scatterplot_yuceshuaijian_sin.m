function judge = scatterplot_yuceshuaijian_sin ( factor1 , factor2 , factor3 )
...
%	factor3=1/3000;
    ...
    Blue_UAV_Location_new_y = ver + factor1 * sin( Blue_UAV_Location_new_x / factor2 ) * exp( -  Blue_UAV_Location_new_x/factor3 );
