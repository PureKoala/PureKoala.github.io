...
while Figure_num < time && Flag_Track && Blue_UAV_Location(end,1)<1.02*10000
    ...
    % 计算红色无人机的飞行方向
    [azimuth_Red_1] = predictdeltasita(Blue_UAV_Location_temp, Red_1_UAV_Location_temp);
    [azimuth_Red_2] = predictdeltasita(Blue_UAV_Location_temp, Red_2_UAV_Location_temp);
    ...
    % 计算红色无人机群1的位置
    Red_1_UAV_Location_new_x = Red_1_UAV_Location_temp(1) + step_length * speed_red_UAV * cos(azimuth_Red_1);
    Red_1_UAV_Location_new_y = Red_1_UAV_Location_temp(2) + step_length * speed_red_UAV * sin(azimuth_Red_1);
    ...
    % 计算红色无人机群2的位置
    Red_2_UAV_Location_new_x = Red_2_UAV_Location_temp(1) + step_length * speed_red_UAV * cos(azimuth_Red_2);
    Red_2_UAV_Location_new_y = Red_2_UAV_Location_temp(2) + step_length * speed_red_UAV * sin(azimuth_Red_2);
