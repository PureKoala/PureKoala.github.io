...
while Figure_num < time && Flag_Track && Blue_UAV_Location(end,1)<1.02*10000
	...
	factor1=10;
	factor2=1/10;
    Blue_UAV_Location_new_x = Blue_UAV_Location_temp(1) + speed_blue_UAV * step_length * 1/sqrt(2);
%    Blue_UAV_Location_new_y = ver+200*sin(Blue_UAV_Location_new_x)*exp(-factor2*Blue_UAV_Location_new_x/500)*factor1;  
	Blue_UAV_Location_new_y = ver+A*sin(Blue_UAV_Location_new_x*w/1000); 	
	...
	jjj=Flag_Track && Figure_num < time;
end