...
%	Blue_UAV_Location_new_y = ver + factor1 * sin( Blue_UAV_Location_new_x * factor2 );
	...
	% 红色航母1，画点
	plot(Red_1_Ship_Location(:,1),Red_1_Ship_Location(:,2),'oc');
	hold on;
	...
	% 红色航母2，画点
	plot(Red_2_Ship_Location(:,1),Red_2_Ship_Location(:,2),'oc');
	hold on;
...
%	Blue_UAV_Location_new_y = ver + factor1 * sin( Blue_UAV_Location_new_x * factor2 );
	...
	% 红色UAV集群3,画线
    plot(Red_3_UAV_Location(:,1),Red_3_UAV_Location(:,2),'b');
    hold on;
    
    % 红色UAV集群3的UAV，画点
    plot(Red_3_1_UAV_Location(end,1),Red_3_1_UAV_Location(end,2),'pb');
    hold on;
    plot(Red_3_2_UAV_Location(end,1),Red_3_2_UAV_Location(end,2),'pb');
    hold on;
    plot(Red_3_3_UAV_Location(end,1),Red_3_3_UAV_Location(end,2),'pb');
    hold on;
    plot(Red_3_4_UAV_Location(end,1),Red_3_4_UAV_Location(end,2),'pb');
    hold on;
    plot(Red_3_5_UAV_Location(end,1),Red_3_5_UAV_Location(end,2),'pb');
    hold on;
	
	% 红色UAV集群4,画线
    plot(Red_4_UAV_Location(:,1),Red_4_UAV_Location(:,2),'b');
    hold on;
    
    % 红色UAV集群4的UAV，画点
    plot(Red_4_1_UAV_Location(end,1),Red_4_1_UAV_Location(end,2),'pb');
    hold on;
    plot(Red_4_2_UAV_Location(end,1),Red_4_2_UAV_Location(end,2),'pb');
    hold on;
    plot(Red_4_3_UAV_Location(end,1),Red_4_3_UAV_Location(end,2),'pb');
    hold on;
    plot(Red_4_4_UAV_Location(end,1),Red_4_4_UAV_Location(end,2),'pb');
    hold on;
    plot(Red_4_5_UAV_Location(end,1),Red_4_5_UAV_Location(end,2),'pb');
    hold on;
